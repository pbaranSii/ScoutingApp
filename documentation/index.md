...
- [Runbooki](runbooks/) – [wdrożenie DEV→PROD](runbooks/deploy-dev-to-prod.md), [migracje](runbooks/apply-migrations.md), [Azure SWA](runbooks/azure-swa-setup.md)
- [Migracja do Azure](azure-migration-overview.md) – dual hosting (Vercel + SWA), [dziennik migracji](azure-migration-log.md)
