...
drop policy if exists "Admin director coach can manage clubs" on public.clubs;
...
drop policy if exists "Admin director coach can manage leagues" on public.leagues;
