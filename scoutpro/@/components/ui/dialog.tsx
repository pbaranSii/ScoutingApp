  ...
  <DialogPortal>
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "relative z-[101] grid w-full max-w-lg gap-4 border border-slate-200 bg-white p-6 shadow-xl sm:rounded-lg max-h-[90vh] overflow-y-auto",
      ...
      >
        ...
        <DialogPrimitive.Close asChild>
          <Button
            ...
            variant="ghost"
            size="icon"
            className="absolute right-5 top-5 h-8 w-8 text-slate-600 hover:text-slate-900"
            aria-label="Zamknij"
          >
            <X className="h-4 w-4" />
          </Button>
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-left pr-10",
      className
    )}
    {...props}
  />
